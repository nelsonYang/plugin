 ...
 * @author nelson
 */
public class ReturnParameterPanel extends JFrame {
    ...
    private JButton button = new JButton("ReturnAdd");
    private JButton ok = new JButton("ok");

    public ReturnParameterPanel(final List<JTextField> parameterNamesList, final List<JComboBox> parameterTypeList, final List<JTextField> descriptionList) {
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JTextField parametername = new JTextField("返回参数名");
                ...
                JTextField parameterDesc = new JTextField("返回参数名描述");
