 ...
 * @author nelson
 */
public class ImportParameterPanel extends JFrame {
    ...
    private JButton button = new JButton("ImportantAdd");
    private JButton ok = new JButton("ok");

    public ImportParameterPanel(final List<JTextField> parameterNamesList, final List<JComboBox> parameterTypeList, final List<JTextField> descriptionList) {
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JTextField parametername = new JTextField("重要参数名");
                ...
                JTextField parameterDesc = new JTextField("重要参数名描述");
